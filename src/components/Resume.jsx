                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 order-sm-1 order-2 mt-4 mt-sm-0">
                        <div className="event event-description-left float-left text-end">
                          ...
                          <p className="timeline-subtitle mt-3 mb-0 text-muted">
                            ...
                            Philippines from 2023-06 to 2024, I was responsible
                            for maintaining the cleanliness and organization of
                            the office space and ensuring a sanitary and safe
                            environment for employees and clients alike. In
                            addition, I also took on the role of IT support,
                            assisting with computer troubleshooting and
                            maintenance.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 mt-4 mt-sm-0">
                        <div className="event event-description-right float-left text-start">
                          ...
                          <p className="timeline-subtitle mt-3 mb-0 text-muted">
                            Founded in 2022, UNCAGED MELODIES empowers
                            innovative artists to express their unique sounds.
                            Our mission is to celebrate originality and foster
                            collaboration across genres. Through strategic
                            marketing and artist development, we amplify diverse
                            voices, creating a vibrant community that encourages
                            authenticity and creativity in music.
                          </p>
                        </div>
                      </div>
                      {/*end col*/}
                    ...
                    <div className="row">
                      <div className="col-lg-6 col-md-6 col-sm-6">
                        <div className="duration date-label-left position-relative text-md-end">
                          ...
                          <h5 className="my-2">La Verdad Christian College</h5>
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 mt-4 mt-sm-0">
                        <div className="event event-description-right position-relative">
                          ...
                          <p className="timeline-subtitle mt-3 mb-0 text-muted">
                            This degree features the fundamentals of the Modern
                            requirements in the tech world.
                          </p>
                        </div>
                      </div>
                      {/*end col*/}
